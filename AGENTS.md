...
- Use Vercel Web Analytics and Speed Insights, mounted once in the root layout. Keep telemetry minimal: do not send custom events or properties containing RSVP, admin, or other guest data without an explicit privacy decision.
