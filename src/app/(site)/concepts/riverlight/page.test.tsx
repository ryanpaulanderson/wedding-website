...
describe("RiverlightPage", () => {
  ...
  it("provides review and in-page navigation", () => {
    render(<RiverlightPage />);

    expect(screen.getByRole("link", { name: "← All concepts" })).toHaveAttribute("href", "/");
